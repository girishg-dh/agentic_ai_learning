...
researcher = Agent(
  ...
  goal=(
      'Gather, process, and analyze real-time financial data, news, and market trends.'
  ),
  backstory=(
...
analyst = Agent(
  ...
  goal=(
      'Analyze the financial data provided by the researcher to identify key insights, risks, and investment opportunities.'
  ),
  backstory=(
